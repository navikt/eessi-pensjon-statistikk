...
data class BucOpprettetHendelseUt(val statistikkMeldingInn: StatistikkMeldingInn, val dokumentOpprettetDato: String?){
    ...
    companion object {
        ...
        fun fromJson(json: String): BucOpprettetHendelseUt = sedMapper.readValue(json, BucOpprettetHendelseUt::class.java)
    }
}