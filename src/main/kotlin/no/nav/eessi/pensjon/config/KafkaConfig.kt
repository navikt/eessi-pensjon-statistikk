...
class KafkaConfig(
    ...
    fun consumerFactory(): ConsumerFactory<String, String> {
        ...
        configMap[ProducerConfig.KEY_SERIALIZER_CLASS_CONFIG] = StringDeserializer::class.java
        configMap[ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG] = JsonDeserializer::class.java
